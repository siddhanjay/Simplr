...
describe('test basic encoding and decoding functionality', function () {
  ...
  it('should decode event from log', function () {
    ...
    var userKey = decoded[0],
        proxy = decoded[1],
        controller = decoded[2],
        recoveryKey = decoded[3];


    assert.deepEqual([userKey, proxy, controller, recoveryKey], ['0x50858f2c7873fac9398ed9c195d185089caa7967', '0x0aa622ec7d114c8a18730a9a6147ffbded11cefa', '0xcec030978d9e5e8b4ad689b1f509f8e9617efbe3', '0x41f50a40900dc9ac8a6d4cfb4fa5e05ed428de42']);
